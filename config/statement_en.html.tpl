...
<div class="statement-body">
    ...
    <div style="color: #7cc576; 
        ...
        <span class="statement-league-alert-content">
            ...
            <!-- BEGIN level1 -->
Welcome to Bit Runner 2048! Since community games do not feature silver/gold/legend, we will use wood leagues as equivalents. <br>
Every rule is availiable from this league! Good luck!
            <!-- END -->
            <!-- BEGIN level2 -->
Welcome to Bronze!
            <!-- END -->
...
Welcome to Legend!
    ...
    <p>
        <strong>Winners of the contest will be placed with nick + avatar in this section on contest end!</strong> <br>
        Contest lasts until 12th of may, 5PM UTC!
    </p>
    ...
    <div class="statement-section statement-rules">
        ...
        <div>
            <div class="statement-rules-content">
                ...
                <var>carCount</var> cars.
                <br> A Car is a disc with a radius of
                <const>400</const> units. 
                <br> <strong>Cars generate a magnetic field, which seizes control of prisoners' escape pods when the distance between them is lower than the Car's radius.</strong>
                <br> Cars glide on the playing field and are subject to friction.
                <br>
                <br>
                <p style="text-align:center"><strong>Game mechanics</strong></p>
                <strong>To capture a prisoner</strong>, a Player must drop him into the man hole.
                <br> A new Prisoner will be trying to escape on the edge of prison yard. <const>2</const> Prisoners are always around trying to escape.
                <br>
                <br>
            ...
            <div class="statement-lose-conditions">
                ...
                <div class="blk">
                    ...
                    <div class="text">
                        <ul>
                            <li>Capture less prisoners than your enemy.</li>
                            <li>Capture your last prisoners last, in case of a draw</li>
        ...
        <div class="statement-expert-rules-content">
            <ul style="margin: 0;">
                ...
                <li>Collisions are (nearly) elastic. A minimal impulse of
                    <const>120</const> is applied for Car-Carcollisions, <const>600</const> for Car-Fence collisions and <const>42</const> for Prisoner-Border collisions</li>
    ...
    <div class="statement-section statement-protocol">
        ...
        <div class="blk">
            ...
            <br>
            <br> If the message is "debug" once, the game summary will contain additional information throughout the game. The referee will provide the list of collision events during the last turn, presented in the following manner: <var>id1</var> <var>id2</var> <var>time</var>.
            ...
            <br>
            <br> To drive like an expert, use: <action>EXPERT angle thrust message</action>.
            <br> <const>-18</const> <= <var>angle</var> <= <const>18</const>
            </div>
        </div>
